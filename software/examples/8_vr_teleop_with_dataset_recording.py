...
def main():
    ...
    global FPS
    parser = argparse.ArgumentParser(description="XLerobot VR Teleop with Dataset Recording")
    ...
    parser.add_argument("--fps", type=int, default=FPS, help="Control loop / dataset frequency")
